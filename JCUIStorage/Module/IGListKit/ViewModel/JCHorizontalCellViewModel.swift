//
//  JCHorizontalCellViewModel.swift
//  JCUIStorage
//
...
class JCHorizontalCellViewModel: NSObject {
...
extension JCHorizontalCellViewModel: ListDiffable {
    func diffIdentifier() -> any NSObjectProtocol {
        return JCIGListUtils.horizontalCellIdentifier as NSString
    }
    
    func isEqual(toDiffableObject object: (any ListDiffable)?) -> Bool {

        guard let object = object as? JCHorizontalCellViewModel else {
            return false
        }
